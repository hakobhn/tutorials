...
```
By this simple extension, EmployeeRepository inherits several com.core.example.methods for working with Employee persistence, including com.core.example.methods for saving, deleting, and finding Employee entities.
...
The Criteria API allows to build up a criteria query object programmatically; the `org.hibernate.Criteria` interface defines the available com.core.example.methods for one of these objects. The Hibernate Session interface contains several overloaded `createCriteria()` com.core.example.methods.
...
The Criteria API provides the **org.hibernate.criterion.Projections** class, which can be used to get average, maximum, or minimum of the property values. The Projections class is similar to the Restrictions class, in that it provides several static factory com.core.example.methods for obtaining **Projection** instances.
```java
Criteria cr = session.createCriteria(Employee.class);
...
public class Txn1 {
	...
	public String toString(){
        ...
        //Getter-Setter com.core.example.methods, omitted for clarity 
}
```
```java
...
public class Customer1 {
	...
	private Txn1 txn;
        ...
        //Getter-Setter com.core.example.methods
}
```
...
* Public getter and setter com.core.example.methods should be defined to access the class attributes.
...
Java Persistence API is a collection of classes and com.core.example.methods to persistently store the vast amounts of data into a database.
...
|Persistence	        |This class contain static com.core.example.methods to obtain EntityManagerFactory instance.|
...
## Q. Name some important com.core.example.interfaces of Hibernate framework?
...
|load() 	                                    |get() 
|-----------------------------------------------|-------------------------------------------------
|Only use the load() method if you are sure that the object exists.|If you are not sure that the object exists, then use one of the get() com.core.example.methods.| 
...
## Q. What is difference between merge() and update() com.core.example.methods in Hibernate?
Both update() and merge() com.core.example.methods in hibernate are used to convert the object which is in detached state into persistence state. But there are different situation where we should be used update() and where should be used merge() method in hibernate
...
#### Q. What is difference between Hibernate save(), saveOrUpdate() and persist() com.core.example.methods?
...
#### Q. Can you explain Hibernate callback com.core.example.interfaces?
...
#### Q. Can you explain the role of addDirectory() and addjar() com.core.example.methods?
...
#### Q. How can we use new custom com.core.example.interfaces to enhance functionality of built-in com.core.example.interfaces of hibernate?
...
#### Q. What the three com.core.example.inheritance models are of hibernate?
#### Q. What is general hibernate flow using RDBMS?
#### Q. What is difference between managed associations and hibernate associations?
#### Q. What are the com.core.example.inheritance mapping strategies?
