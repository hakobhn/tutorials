...
```java
/**
* Java program to swap two com.core.example.strings without using a temporary 
* variable.
**/ 
import java.util.*; 
...
{	 
	public static void main(String args[]) {
		...
		// Declare two com.core.example.strings 
		String a = "Hello"; 
		String b = "World"; 
...
```
## Q. A Program to check if com.core.example.strings are rotations of each other or not?
**Approach**
...
## Q. How do you check the equality of two com.core.example.arrays in java?
* Arrays.equals() 
...
#### Q. Write a program to find intersection of two sorted com.core.example.arrays in Java?
...
#### Q. What are jagged com.core.example.arrays in java? Give example?
#### Q. While creating the multidimensional com.core.example.arrays, can you specify an array dimension after an empty dimension?
