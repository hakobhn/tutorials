...
Object
```
## Q. Which of the following interface is used to declare core com.core.example.methods in java?
* Set
* EventListner
* Collection
* Comparator
...
B. It defaults to null.  
```
## Q. How many of the following com.core.example.methods compile?
```java
public class Test 
{
...
C. Two
```
**Explanation**: Objects have instance com.core.example.methods while primitives do not. Since int is a primitive, you cannot call instance com.core.example.methods on it. Integer and String are both objects and have instance com.core.example.methods.
...
A. You can call com.core.example.methods on a primitive.  
